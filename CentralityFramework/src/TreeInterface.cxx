...
int number_tracks;
   ...
   // CentralityDetectorEvent psd; 
	...
	if (true) { fContainer->AddDetector(veto); }
    }
   ...
   /* else if (fPsdGeomConfig == "NA61"){
	...
	std::vector <float> veto;
//cout << "Debug 1" << endl;
//int entry;
//while(entry < fInTree->GetEntries()) {
		//fInTree->GetEntry(entry);
		if (VetoEn<=9000) veto.push_back(VetoEn);
		sts.push_back(number_tracks);
		//cout<<" Veto = "<<VetoEn<<"sts = "<<number_tracks<<endl;
		//entry++;
	//}
//cout << "Debug 2" << endl;
	 ...
	 fContainer->AddDetectorEvent (1, veto);    
//cout << "Debug 3" << endl;
