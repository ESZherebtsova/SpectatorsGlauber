...
//             std::cout << std::endl;
	...
	//cout<<"NormFactor1 = "<<NormFactor1<<"fContainer->GetDetectorWeight(Det1Id) = "<<fContainer->GetDetectorWeight(Det1Id)<<"det1max = "<<det1max<<endl;
	...
	//cout<<"Event = "<<i<<"det1 = "<<det1<<"det2 = "<<det2<<endl;
...
//    TCanvas *cr2 = new TCanvas("cr2", "canvasr", 800, 600);
//    cr2->cd();
