...
class GlauberFitter : public TNamed
{
	...
	GlauberFitter() ;
        ...
        void NormalizeGlauberFit (Int_t StartBin = 40);
	...
	void SetNBD2hist(Double_t mu, Double_t k);
        /**   Destructor   **/
	...
	//void SetConfig (TString config) { fConfig = config; }
        
    private:

	/**   Data members  **/
        TH1F *hNpart, *hNcoll, *hData, *hNBD, *hNBD2, *hGlaub, *hBestFit, *hNspecTarget, *hNpartTarget, *hNpartModified, *hNspecModified;
        TTree* fSimTree;
        TTree* fSimTree2;
	TTree* fSimTree3;

        Float_t fNpart, fNcoll, fNpartTarget, fNspecTarget, fNpartModified, fNspecModified;
